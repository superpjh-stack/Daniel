...
import { isParentOfStudent, getChildrenByParentId, getStudentAttendanceHistory, getStudentAttendanceStats, getStudentAttendanceStreak } from '@/lib/db';
...
export async function GET(request: NextRequest) {
  ...
  const attendance = await getStudentAttendanceHistory(studentId, limit);
