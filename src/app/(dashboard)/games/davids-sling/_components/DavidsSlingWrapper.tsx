...
import DavidsSlingGame from './DavidsSlingGame';
...
export default function DavidsSlingWrapper({ students }: Props) {
  ...
  return (
    <div className="space-y-3">
      ...
      <DavidsSlingGame studentId={selectedStudent || undefined} />
    </div>
  );
}
